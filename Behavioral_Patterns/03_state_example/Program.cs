...
//Demonstrates how the State pattern can handle a very simple game called RPC (which stands for Run, Panic, Calm Down).
//In this single-person game, the player can be in one of four states: • Resting • Attacking • Panicking • Moving.


namespace _03_state_example
{
