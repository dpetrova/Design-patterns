...
namespace _11_adapter_pluggable_example
{
    ...
    public class MyCoolBook : MyOpenBook
    {
        ...
        {
            Add("\r\n");
            if (community.ContainsKey(who)) community[who].Add(Name, "Poked you");
            else Add("Friend " + who + " is not part of the community");
        }
        ...
        {
            if (community.ContainsKey(friend)) community[friend].Add(Name + " : " + message);
            else Add("Friend " + friend + " is not part of the community");
        }
    }
    ...
    public class Interact : Form
    {
        ...
        public void Input(object source, EventArgs e)
        {
            ...
            if (InputEvent != null) InputEvent(this, EventArgs.Empty, who);
        }

        public void Output(string message)
        {
            if (this.InvokeRequired) this.Invoke((MethodInvoker)delegate () { Output(message); });
            else
            {
